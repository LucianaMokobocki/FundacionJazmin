...
export default function Page() {
  return <main id="contenido">
    <PageHero eyebrow="Sé parte" title="Ayudanos a cambiar el mundo jugando." text="Con tu ayuda podemos seguir creando espacios de juego inclusivos y accesibles para todos los niños y niñas de nuestro país." image={images.donarHero}/>
